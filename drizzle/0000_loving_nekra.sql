...
CREATE INDEX IF NOT EXISTS "product_options_product_id_idx" ON "product_options" USING btree ("product_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "product_skus_product_id_idx" ON "product_skus" USING btree ("product_id");